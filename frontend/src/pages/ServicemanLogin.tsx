...
const ServicemanLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await axios.post('http://localhost:5000/api/auth/login/serviceman', formData);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-8 text-white relative overflow-hidden">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-center">Serviceman Login</h2>
              <p className="text-center text-purple-100 mt-2">Manage your services</p>
            </motion.div>
          </div>
        ...
        >
          {['Flexible Hours', 'Good Earnings', 'Support Team'].map((feature, idx) => (
            <motion.div
              key={idx}
